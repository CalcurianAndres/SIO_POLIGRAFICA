...
app.get('/api/createMark', (req, res)=>{
    ...
    const options = {
        ...
        print("C:/Users/administrador.POLINDUSTRIAL/Desktop/SIO2025B-main/PRUEBA.pdf", options).then(console.log).catch(console.log);
...
app.post('/api/prints', (req, res)=>{
    ...
    Gestion.findByIdAndUpdate(body.gestion, change, (err, GestionDB)=>{
        ...
        setTimeout(() => {
            print("C:/Users/administrador.POLINDUSTRIAL/Desktop/SIO2025B-main/documento_test.pdf", options).then(console.log).catch(console.log);
            //console.log('SE REALIZÓ LA IMPRESION DE LA ETIQUETA...')
            res.json('ok')
        },2000);
    })
...
app.get('/api/copy/:orden/:cantidad', (req, res)=>{
    ...
    setTimeout(() => {
        fs.copyFile("C:/Users/administrador.POLINDUSTRIAL/Desktop/SIO2025B-main/documento_test.pdf", path, (err) => {
            if (err) throw err;
